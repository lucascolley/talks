...
+    v = self._xp.zeros(self.shape[-1], dtype=self._xp.int8)
```
...
## Finally: don't underestimate the 'easy' work

- Deadlines on research put pressure on you to get working prototypes and results
- Creating solid foundations which can be re-used by others may entail a big time commitment
