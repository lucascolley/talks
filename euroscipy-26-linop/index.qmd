...
- Operations between `LinearOperator` instances are performed lazily,
e.g. defining the `matvec` method in terms of the methods of the input operators
- Some NumPy functions/methods were used for internal data wrangling,
e.g. `np.hstack` and `obj.reshape`
...
- We can assume that user-provided callables support batched computation,
_if_ they want it to work through this interface.
