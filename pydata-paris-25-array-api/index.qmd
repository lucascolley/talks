...
Master's Student, University of Oxford
- Just finished working @ [prefix.dev](https://prefix.dev)\
...
![](figures/np-data-science.png){height=550 fig-align="center"}
...
- decent support in `ndonnx`, `cubed-dev/cubed`, `pydata/sparse`, `Blosc/python-blosc2`
...
- dispatching (~automatic delegation)
    - c.f. [scientific-python/spatch](https://scientific-python.github.io/spatch/)
...
- `mdhaber/marray`
    - masked arrays with any array backend (like `numpy.ma`)
- `quantity-dev/quantity-array`
...
- Come and chat about the standard, and/or contribute to `scikit-learn` or `array-api-extra`!
...
- the PyData Paris organisers and volunteers
