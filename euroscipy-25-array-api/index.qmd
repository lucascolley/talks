...
![[Aaron's SciPy 2023 Talk](https://youtu.be/16rB-fosAWw)](figures/array-api-talk.png){height=400}
...
- coverage docs
- checkout out Evgeni's talk tomorrow for more info on future SciPy work: [https://euroscipy.org/talks/VAPDZX/](https://euroscipy.org/talks/VAPDZX/)
...
- TODO: compiled code: delegation, translation, dispatching
    - `spatial.transform` example
...
[^2]: thanks to Olivier Grisel for this update!
